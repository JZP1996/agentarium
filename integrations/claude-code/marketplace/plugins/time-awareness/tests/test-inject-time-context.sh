...
assert_not_contains "Opted-in does not bypass permissions" "$OUTPUT" 'permissionDecision'
...
assert_not_contains "Does not bypass permissions" "$OUTPUT" 'permissionDecision'
assert_not_contains "Has no permission decision reason" "$OUTPUT" "permissionDecisionReason"
